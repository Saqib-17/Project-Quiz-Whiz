...
import physicsIcon from '../assets/physics.svg';  // Importing the icons for the subjects
      ...
      <section className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 justify-center lg:pt-36 pt-6">
          ...
          <div
            ...
            onClick={() => window.location.href = '/question'}  // Update the route for your app
          >
