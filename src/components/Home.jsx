        ...
        <div className="flex flex-col lg:flex-row-reverse items-center text-primary-color gap-10 lg:gap-24">
          ...
          <div className="flex flex-col items-center lg:items-start lg:gap-16 space-y-4">
            ...
            <button
              ...
              className="bg-secondary-color px-2 mx-auto lg:px-16 shadow-[0_20px_50px_rgba(211,_104,_49,_0.7)] text-primary-color rounded-xl lg:text-3xl text-xl lg:py-8 py-4 font-normal hover:bg-pink hover:text-white transition-transform transform hover:scale-105"
            >
              Start Quiz
            </button>
